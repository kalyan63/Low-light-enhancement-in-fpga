...
HD_PWD='C:/Users/PRUDVI TEJ/Desktop/Vivado/lowlevel/lowlevel.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LowLight.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LowLight.tcl
